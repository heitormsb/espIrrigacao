...
/* AP Configuration */
#define EXAMPLE_ESP_WIFI_AP_SSID           CONFIG_ESP_WIFI_SSID_AP
#define EXAMPLE_ESP_WIFI_AP_PASSWD         CONFIG_ESP_WIFI_PASSWORD_AP
...
esp_netif_t *wifi_init_sta(char *ssid, char *password)
{
    ...
    strncpy((char*)wifi_sta_config.sta.password,(char*)password, 64);
...
int init_ap(char *ssid, char *password, int modo){
